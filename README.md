...
>
> Five algorithms work -- **SHA-256d, Blake2s, Scrypt (N=1024), SHA3-256t and KawPoW** -- and
> each has had shares accepted by a real pool. There is no tagged release and no binary to
> download: build it yourself, and expect the command-line surface to keep moving.
>
