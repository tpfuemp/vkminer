// A ProgPoW fork, specialized: the period's program is the pipeline, not the
// data.
...
// The twelve cache reads: which register indexes the 16 KiB, which one the
// result is merged into, and how. Twelve is MeraKi's count, the widest here;
// KawPoW draws eleven and leaves the last set unread.
...
layout(constant_id =  41) const uint kCacheSrc11  = 0u;
layout(constant_id =  42) const uint kCacheDst11  = 0u;
layout(constant_id =  43) const uint kCacheSel11  = 0u;
...
layout(constant_id =  44) const uint kMathA0      = 0u;
layout(constant_id =  45) const uint kMathB0      = 0u;
layout(constant_id =  46) const uint kMathOp0     = 0u;
layout(constant_id =  47) const uint kMathDst0    = 0u;
layout(constant_id =  48) const uint kMathSel0    = 0u;

layout(constant_id =  49) const uint kMathA1      = 0u;
layout(constant_id =  50) const uint kMathB1      = 0u;
layout(constant_id =  51) const uint kMathOp1     = 0u;
layout(constant_id =  52) const uint kMathDst1    = 0u;
layout(constant_id =  53) const uint kMathSel1    = 0u;

layout(constant_id =  54) const uint kMathA2      = 0u;
layout(constant_id =  55) const uint kMathB2      = 0u;
layout(constant_id =  56) const uint kMathOp2     = 0u;
layout(constant_id =  57) const uint kMathDst2    = 0u;
layout(constant_id =  58) const uint kMathSel2    = 0u;

layout(constant_id =  59) const uint kMathA3      = 0u;
layout(constant_id =  60) const uint kMathB3      = 0u;
layout(constant_id =  61) const uint kMathOp3     = 0u;
layout(constant_id =  62) const uint kMathDst3    = 0u;
layout(constant_id =  63) const uint kMathSel3    = 0u;

layout(constant_id =  64) const uint kMathA4      = 0u;
layout(constant_id =  65) const uint kMathB4      = 0u;
layout(constant_id =  66) const uint kMathOp4     = 0u;
layout(constant_id =  67) const uint kMathDst4    = 0u;
layout(constant_id =  68) const uint kMathSel4    = 0u;

layout(constant_id =  69) const uint kMathA5      = 0u;
layout(constant_id =  70) const uint kMathB5      = 0u;
layout(constant_id =  71) const uint kMathOp5     = 0u;
layout(constant_id =  72) const uint kMathDst5    = 0u;
layout(constant_id =  73) const uint kMathSel5    = 0u;

layout(constant_id =  74) const uint kMathA6      = 0u;
layout(constant_id =  75) const uint kMathB6      = 0u;
layout(constant_id =  76) const uint kMathOp6     = 0u;
layout(constant_id =  77) const uint kMathDst6    = 0u;
layout(constant_id =  78) const uint kMathSel6    = 0u;

layout(constant_id =  79) const uint kMathA7      = 0u;
layout(constant_id =  80) const uint kMathB7      = 0u;
layout(constant_id =  81) const uint kMathOp7     = 0u;
layout(constant_id =  82) const uint kMathDst7    = 0u;
layout(constant_id =  83) const uint kMathSel7    = 0u;

layout(constant_id =  84) const uint kMathA8      = 0u;
layout(constant_id =  85) const uint kMathB8      = 0u;
layout(constant_id =  86) const uint kMathOp8     = 0u;
layout(constant_id =  87) const uint kMathDst8    = 0u;
layout(constant_id =  88) const uint kMathSel8    = 0u;

layout(constant_id =  89) const uint kMathA9      = 0u;
layout(constant_id =  90) const uint kMathB9      = 0u;
layout(constant_id =  91) const uint kMathOp9     = 0u;
layout(constant_id =  92) const uint kMathDst9    = 0u;
layout(constant_id =  93) const uint kMathSel9    = 0u;

layout(constant_id =  94) const uint kMathA10     = 0u;
layout(constant_id =  95) const uint kMathB10     = 0u;
layout(constant_id =  96) const uint kMathOp10    = 0u;
layout(constant_id =  97) const uint kMathDst10   = 0u;
layout(constant_id =  98) const uint kMathSel10   = 0u;

layout(constant_id =  99) const uint kMathA11     = 0u;
layout(constant_id = 100) const uint kMathB11     = 0u;
layout(constant_id = 101) const uint kMathOp11    = 0u;
layout(constant_id = 102) const uint kMathDst11   = 0u;
layout(constant_id = 103) const uint kMathSel11   = 0u;

layout(constant_id = 104) const uint kMathA12     = 0u;
layout(constant_id = 105) const uint kMathB12     = 0u;
layout(constant_id = 106) const uint kMathOp12    = 0u;
layout(constant_id = 107) const uint kMathDst12   = 0u;
layout(constant_id = 108) const uint kMathSel12   = 0u;

layout(constant_id = 109) const uint kMathA13     = 0u;
layout(constant_id = 110) const uint kMathB13     = 0u;
layout(constant_id = 111) const uint kMathOp13    = 0u;
layout(constant_id = 112) const uint kMathDst13   = 0u;
layout(constant_id = 113) const uint kMathSel13   = 0u;

layout(constant_id = 114) const uint kMathA14     = 0u;
layout(constant_id = 115) const uint kMathB14     = 0u;
layout(constant_id = 116) const uint kMathOp14    = 0u;
layout(constant_id = 117) const uint kMathDst14   = 0u;
layout(constant_id = 118) const uint kMathSel14   = 0u;

layout(constant_id = 119) const uint kMathA15     = 0u;
layout(constant_id = 120) const uint kMathB15     = 0u;
layout(constant_id = 121) const uint kMathOp15    = 0u;
layout(constant_id = 122) const uint kMathDst15   = 0u;
layout(constant_id = 123) const uint kMathSel15   = 0u;

layout(constant_id = 124) const uint kMathA16     = 0u;
layout(constant_id = 125) const uint kMathB16     = 0u;
layout(constant_id = 126) const uint kMathOp16    = 0u;
layout(constant_id = 127) const uint kMathDst16   = 0u;
layout(constant_id = 128) const uint kMathSel16   = 0u;

layout(constant_id = 129) const uint kMathA17     = 0u;
layout(constant_id = 130) const uint kMathB17     = 0u;
layout(constant_id = 131) const uint kMathOp17    = 0u;
layout(constant_id = 132) const uint kMathDst17   = 0u;
layout(constant_id = 133) const uint kMathSel17   = 0u;
...
layout(constant_id = 134) const uint kDagDst0     = 0u;
layout(constant_id = 135) const uint kDagSel0     = 0u;

layout(constant_id = 136) const uint kDagDst1     = 0u;
layout(constant_id = 137) const uint kDagSel1     = 0u;

layout(constant_id = 138) const uint kDagDst2     = 0u;
layout(constant_id = 139) const uint kDagSel2     = 0u;

layout(constant_id = 140) const uint kDagDst3     = 0u;
layout(constant_id = 141) const uint kDagSel3     = 0u;
...
layout(constant_id = 142) const uint kDagLines    = 1u;
...
//
// Written out to the widest fork's count and each operation guarded by its own
// number. A narrower fork's guard is false against a specialization constant,
// so the operation is not in the binary at all -- and if it were, the constants
// it would run on are the zeros the host left there.
...
void main()
{
    ...
    for (uint r = 0u; r < kRounds; r++) {
        ...
        CACHE_OP(1u, kCacheSrc1, kCacheDst1, kCacheSel1);
        MATH_OP(1u, kMathA1, kMathB1, kMathOp1, kMathDst1, kMathSel1);
        CACHE_OP(2u, kCacheSrc2, kCacheDst2, kCacheSel2);
        MATH_OP(2u, kMathA2, kMathB2, kMathOp2, kMathDst2, kMathSel2);
        CACHE_OP(3u, kCacheSrc3, kCacheDst3, kCacheSel3);
        MATH_OP(3u, kMathA3, kMathB3, kMathOp3, kMathDst3, kMathSel3);
        CACHE_OP(4u, kCacheSrc4, kCacheDst4, kCacheSel4);
        MATH_OP(4u, kMathA4, kMathB4, kMathOp4, kMathDst4, kMathSel4);
        CACHE_OP(5u, kCacheSrc5, kCacheDst5, kCacheSel5);
        MATH_OP(5u, kMathA5, kMathB5, kMathOp5, kMathDst5, kMathSel5);
        CACHE_OP(6u, kCacheSrc6, kCacheDst6, kCacheSel6);
        MATH_OP(6u, kMathA6, kMathB6, kMathOp6, kMathDst6, kMathSel6);
        CACHE_OP(7u, kCacheSrc7, kCacheDst7, kCacheSel7);
        MATH_OP(7u, kMathA7, kMathB7, kMathOp7, kMathDst7, kMathSel7);
        CACHE_OP(8u, kCacheSrc8, kCacheDst8, kCacheSel8);
        MATH_OP(8u, kMathA8, kMathB8, kMathOp8, kMathDst8, kMathSel8);
        CACHE_OP(9u, kCacheSrc9, kCacheDst9, kCacheSel9);
        MATH_OP(9u, kMathA9, kMathB9, kMathOp9, kMathDst9, kMathSel9);
        CACHE_OP(10u, kCacheSrc10, kCacheDst10, kCacheSel10);
        MATH_OP(10u, kMathA10, kMathB10, kMathOp10, kMathDst10, kMathSel10);
        CACHE_OP(11u, kCacheSrc11, kCacheDst11, kCacheSel11);
        MATH_OP(11u, kMathA11, kMathB11, kMathOp11, kMathDst11, kMathSel11);
        MATH_OP(12u, kMathA12, kMathB12, kMathOp12, kMathDst12, kMathSel12);
        MATH_OP(13u, kMathA13, kMathB13, kMathOp13, kMathDst13, kMathSel13);
        MATH_OP(14u, kMathA14, kMathB14, kMathOp14, kMathDst14, kMathSel14);
        MATH_OP(15u, kMathA15, kMathB15, kMathOp15, kMathDst15, kMathSel15);
        MATH_OP(16u, kMathA16, kMathB16, kMathOp16, kMathDst16, kMathSel16);
        MATH_OP(17u, kMathA17, kMathB17, kMathOp17, kMathDst17, kMathSel17);
